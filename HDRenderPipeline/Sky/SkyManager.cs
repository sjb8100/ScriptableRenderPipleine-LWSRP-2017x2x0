...
namespace UnityEngine.Experimental.Rendering.HDPipeline
{
    ...
    public class SkyManager
    {
        ...
        public void UpdateEnvironment(Camera camera, Light sunLight, ScriptableRenderContext renderContext)
        {
            /*
        ...
        public void RenderSky(Camera camera, Light sunLight, RenderTargetIdentifier colorBuffer, RenderTargetIdentifier depthBuffer, ScriptableRenderContext renderContext)
        {
            /*
